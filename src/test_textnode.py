...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_node_init_italic(self):
        ...
        """
        node3 = TextNode("This is italic text", "italic")
    ...
    def test_text_node_init_code(self):
        ...
        """
        node4 = TextNode("This is code text", "code")
    ...
    def test_text_node_init_link(self):
        ...
        """
        node5 = TextNode("This is link text", "link", "https://localhost:8888")
    ...
    def test_text_node_init_image(self):
        ...
        """
        node6 = TextNode("This is image text", "image", "src/images/favicon.ico")
    ...
    def test_text_node_init_text_by_default(self):
        ...
        self.assertEqual(node7.text_type.value, "text")
    ...
    def test_text_node_init_none(self):
        ...
        self.assertEqual(node8.text_type.value, "text")

    def test_text_node_eq(self):
        """
        Test TextNode is __eq__ method
        """
        node = TextNode("This is a link node", "link", "https://localhost8888")
        node2 = TextNode("This is a link node", "link", "https://localhost8888")
    ...
    def test_text_node_not_eq(self):
        ...
        """
        node3 = TextNode("This is different text", "text")
        node4 = TextNode("This text varies from above", "text")
    ...
    def test_text_url_not_eq(self):
        ...
        """
        node5 = TextNode("This is an image node with a url", "image", "src/img/image1")
        node6 = TextNode("This is an image node with a url", "image", "src/img/image2")
    ...
    def test_text_node_to_html_node_text(self):
        ...
        plain_html_node = text_node_to_html_node(
            TextNode("This is plain text", "text", None)
        )
