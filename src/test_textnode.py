...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_node_init_link(self):
        ...
        """
        node5 = TextNode("This is link text", TextType.LINK, "https://localhost:8888")
    ...
    def test_text_node_init_image(self):
        ...
        """
        node6 = TextNode("This is image text", TextType.IMAGE, "src/images/favicon.ico")
        self.assertEqual(node6.text, "This is image text")
        self.assertEqual(node6.text_type, TextType.IMAGE)
        self.assertEqual(node6.url, "src/images/favicon.ico")

    def test_text_node_init_text_by_default(self):
        """
        Test TextNode init with no specified text type, default is text
        """
        node7 = TextNode("Inferred text text")
        self.assertEqual(node7.text, "Inferred text text")
        self.assertEqual(node7.text_type, TextType.TEXT)
    ...
    def test_text_node_init_none(self):
        ...
        self.assertEqual(node8.text_type, TextType.TEXT)

    def test_text_node_eq(self):
        """
        Test TextNode is __eq__ method
        """
        node = TextNode("This is a link node", TextType.LINK, "https://localhost8888")
        node2 = TextNode("This is a link node", TextType.LINK, "https://localhost8888")
    ...
    def test_text_node_not_eq(self):
        ...
        """
        node3 = TextNode("This is different text", TextType.TEXT)
        node4 = TextNode("This text varies from above", TextType.TEXT)
    ...
    def test_text_url_not_eq(self):
        ...
        """
        node5 = TextNode(
            "This is an image node with a url", TextType.IMAGE, "src/img/image1"
        )
        node6 = TextNode(
            "This is an image node with a url", TextType.IMAGE, "src/img/image2"
        )
        self.assertNotEqual(node5, node6)

    def test_text_node_to_html_node_text(self):
        """
        Test text_node_to_html_node function with text text
        """
        plain_html_node = text_node_to_html_node(
            TextNode("This is plain text", TextType.TEXT, None)
        )
    ...
    def test_text_node_to_html_node_italic(self):
        ...
        italic_html_node = text_node_to_html_node(
            TextNode("This is italic text", TextType.ITALIC, None)
        )
    ...
    def test_text_node_to_html_node_code(self):
        ...
        code_html_node = text_node_to_html_node(
            TextNode("This is code text", TextType.CODE, None)
        )
    ...
    def test_text_node_to_html_node_link(self):
        ...
        link_html_node = text_node_to_html_node(
            TextNode("This is link text", TextType.LINK, "https://localhost:8888")
        )
        self.assertEqual(link_html_node.tag, "a")
        self.assertEqual(link_html_node.value, "This is link text")
        self.assertEqual(
            link_html_node.props_to_html(), 'href="https://localhost:8888"'
        )
    ...
    def test_text_node_to_html_node_image(self):
        ...
        img_html_node = text_node_to_html_node(
            TextNode("This is img alt text", TextType.IMAGE, "src/img/favicon.jpg")
        )
        self.assertEqual(img_html_node.tag, "img")
        self.assertEqual(img_html_node.value, "")
        self.assertEqual(
            img_html_node.props_to_html(),
            'src="src/img/favicon.jpg" alt="This is img alt text"',
        )

    # def test_text_node_to_html_node_no_type(self):
    #     """
    #     Test text node without text_type attribute; should raiseError
    #     """
    #     with self.assertRaises(ValueError):
    #         text_node_to_html_node(TextNode("This is untyped text", None, None))
